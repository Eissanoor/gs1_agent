...
module.exports = {
    ...
    whychoose: {
        synonyms: ['why choose us', 'why choose', 'why choose us page',
            'why choose page', 'why choose us section', 'why choose page section',
            'navigate to why choose us page', 'navigate to why choose page'],
        path: 'why-choose-us',
        suggestion: 'navigate to why choose us page'
    },
    team: {
        synonyms: ['our team', 'team', 'our team page', 'team page',
            'our team section', 'go to our team page', 'go to team page',
            'navigate to our team page', 'navigate to team page'],
        path: 'our-team',
        suggestion: 'navigate to our team page'
    },
    boardmember: {
        synonyms: ['board member', 'board member page', 'board member section',
            'navigate to board member page', 'go to board member page',
            'board member', 'board member page', 'board member section',
            'navigate to board member page', 'go to board member page',
            'board member', 'board member page', 'board member section',
            'navigate to board member page', 'go to board member page'],
        path: 'board-member',
        suggestion: 'navigate to board member page'
    },
    gs1benefits: {
        synonyms: ['gs1 benefits', 'gs1 benefits page', 'benefits', 'benefits page',
            'navigate to benefits page', 'go to benefits page',
            'benefits', 'benefits page', 'benefits section',
            'navigate to benefits page', 'go to benefits page',
            'benefits', 'benefits page', 'benefits section',
            'navigate to benefits page', 'go to benefits page',
        ],
        path: 'gs1-benefits',
        suggestion: 'navigate to gs1 benefits page'
    },
    gs1systemstandards: {
        synonyms: ['gs1 system standards', 'system standards', 'system standards page',
            'navigate to system standards page', 'go to system standards page',
            'system standards', 'system standards page', 'system standards section',
            'navigate to system standards page', 'go to system standards page',
            'system standards', 'system standards page', 'system standards section',
            'navigate to system standards page', 'go to system standards page',
        ],
        path: 'gs1-system-standards',
        suggestion: 'navigate to gs1 system standards page'
    },
    globalproductclassification: {
        synonyms: ['global product classification', 'global product classification page',
    ...
    userguide:{
        synonyms: ['user guide', 'user guide page', 'user guide section',
            'navigate to user guide page', 'go to user guide page',
            'user guide', 'user guide page', 'user guide section',
            'navigate to user guide page', 'go to user guide page',
            'user guide', 'user guide page', 'user guide section',
            'navigate to user guide page', 'go to user guide page',
        ],
        path: 'user-guide',
        suggestion: 'navigate to user guide page'
    },
    home:{
        synonyms: ['home', 'home page', 'home section',
    ...
    gs1healthcare:{
        synonyms: ['gs1 healthcare', 'gs1 healthcare page', 'gs1 healthcare section',
            'navigate to gs1 healthcare page', 'go to gs1 healthcare page',
            'gs1 healthcare', 'gs1 healthcare page', 'gs1 healthcare section',
            'navigate to gs1 healthcare page', 'go to gs1 healthcare page',
            'gs1 healthcare', 'gs1 healthcare page', 'gs1 healthcare section',
            'navigate to gs1 healthcare page', 'go to gs1 healthcare page','healthcare'
        ],
        path: 'gs1-healthcare',
        suggestion: 'navigate to gs1 healthcare page'
    },
    gs1standards:{
        synonyms: ['gs1 standards', 'gs1 standards page', 'gs1 standards section',
            'navigate to gs1 standards page', 'go to gs1 standards page',
            'gs1 standards', 'gs1 standards page', 'gs1 standards section',
            'navigate to gs1 standards page', 'go to gs1 standards page',
            'gs1 standards', 'gs1 standards page', 'gs1 standards section',
            'navigate to gs1 standards page', 'go to gs1 standards page','standards'
        ],
        path: 'gs1-standards',
        suggestion: 'navigate to gs1 standards page'
    },
    foodandbeverage:{
        synonyms: ['food and beverage', 'food and beverage page', 'food and beverage section',
            'navigate to food and beverage page', 'go to food and beverage page',
            'food and beverage', 'food and beverage page', 'food and beverage section',
            'navigate to food and beverage page', 'go to food and beverage page',
            'food and beverage', 'food and beverage page', 'food and beverage section',
            'navigate to food and beverage page', 'go to food and beverage page','food and beverage'
        ],
        path: 'food-and-beverage',
        suggestion: 'navigate to food and beverage page'
    },
    manufacturingsectors:{
        synonyms: ['manufacturing sectors', 'manufacturing sectors page', 'manufacturing sectors section',
            'navigate to manufacturing sectors page', 'go to manufacturing sectors page',
            'manufacturing sectors', 'manufacturing sectors page', 'manufacturing sectors section',
            'navigate to manufacturing sectors page', 'go to manufacturing sectors page',
            'manufacturing sectors', 'manufacturing sectors page', 'manufacturing sectors section',
            'navigate to manufacturing sectors page', 'go to manufacturing sectors page','manufacturing sectors'
        ],
        path: 'manufacturing-sectors',
        suggestion: 'navigate to manufacturing sectors page'
    },
    smallbusiness:{
        synonyms: ['small business', 'small business page', 'small business section',
            'navigate to small business page', 'go to small business page',
            'small business', 'small business page', 'small business section',
            'navigate to small business page', 'go to small business page',
            'small business', 'small business page', 'small business section',
            'navigate to small business page', 'go to small business page','small business'
        ],
        path: 'small-business',
        suggestion: 'navigate to small business page'
    },
    trasnportandlogistics:{
        synonyms: ['transport and logistics', 'transport and logistics page', 'transport and logistics section',
            'navigate to transport and logistics page', 'go to transport and logistics page',
            'transport and logistics', 'transport and logistics page', 'transport and logistics section',
            'navigate to transport and logistics page', 'go to transport and logistics page',
            'transport and logistics', 'transport and logistics page', 'transport and logistics section',
            'navigate to transport and logistics page', 'go to transport and logistics page','transport and logistics'
        ],
        path: 'transport-and-logistics',
        suggestion: 'navigate to transport and logistics page'
    },
    governmentpublicsector:{
        synonyms: ['government public sector', 'government public sector page', 'government public sector section',
            'navigate to government public sector page', 'go to government public sector page',
            'government public sector', 'government public sector page', 'government public sector section',
            'navigate to government public sector page', 'go to government public sector page',
            'government public sector', 'government public sector page', 'government public sector section',
            'navigate to government public sector page', 'go to government public sector page','government public sector'
        ],
        path: 'government-public-sector',
        suggestion: 'navigate to government public sector page'
    },
    gdti:{
        synonyms: ['gdti', 'gdti page', 'gdti section',
            'navigate to gdti page', 'go to gdti page',
            'gdti', 'gdti page', 'gdti section',
            'navigate to gdti page', 'go to gdti page',
            'gdti', 'gdti page', 'gdti section',
            'navigate to gdti page', 'go to gdti page','gdti','bank'
        ],
        path: 'gdti',
        suggestion: 'navigate to gdti page'
    },
    technicalindustries:{
        synonyms: ['technical industries', 'technical industries page', 'technical industries section',
            'navigate to technical industries page', 'go to technical industries page',
            'technical industries', 'technical industries page', 'technical industries section',
            'navigate to technical industries page', 'go to technical industries page',
            'technical industries', 'technical industries page', 'technical industries section',
            'navigate to technical industries page', 'go to technical industries page','technical industries'
        ],
        path: 'technical-industries',
        suggestion: 'navigate to technical industries page'
    },
    manufacturingsectors:{
        synonyms: ['manufacturing sectors', 'manufacturing sectors page', 'manufacturing sectors section',
            'navigate to manufacturing sectors page', 'go to manufacturing sectors page',
    ...
    gs1traceabilitysolution:{
        synonyms: ['gs1 traceability solution', 'gs1 traceability solution page', 'gs1 traceability solution section',
            'navigate to gs1 traceability solution page', 'go to gs1 traceability solution page',
            'gs1 traceability solution', 'gs1 traceability solution page', 'gs1 traceability solution section',
            'navigate to gs1 traceability solution page', 'go to gs1 traceability solution page',
            'gs1 traceability solution', 'gs1 traceability solution page', 'gs1 traceability solution section',
            'navigate to gs1 traceability solution page', 'go to gs1 traceability solution page','gs1 traceability solution',
            'traceability'
        ],
        path: 'gs1-traceability-solution',
        suggestion: 'navigate to gs1 traceability solution page'
    },
    productcompliance:{
        synonyms: ['product compliance', 'product compliance page', 'product compliance section',
            'navigate to product compliance page', 'go to product compliance page',
            'product compliance', 'product compliance page', 'product compliance section',
            'navigate to product compliance page', 'go to product compliance page',
            'product compliance', 'product compliance page', 'product compliance section',
            'navigate to product compliance page', 'go to product compliance page','product compliance'
        ],
        path: 'product-compliance',
        suggestion: 'navigate to product compliance page'
    },
    verifiedbygs1:{
        synonyms: ['verified by gs1', 'verified by gs1 page', 'verified by gs1 section',
            'navigate to verified by gs1 page', 'go to verified by gs1 page',
            'verified by gs1', 'verified by gs1 page', 'verified by gs1 section',
            'navigate to verified by gs1 page', 'go to verified by gs1 page',
            'verified by gs1', 'verified by gs1 page', 'verified by gs1 section',
            'navigate to verified by gs1 page', 'go to verified by gs1 page','verified by gs1'
        ],
        path: 'verified-by-gs1',
        suggestion: 'navigate to verified by gs1 page'
    },
